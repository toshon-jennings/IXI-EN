...
- No replication of old example compositions — a new metaphor was generated for the current article.
...
If any of the following appear, regenerate or do local editing:
...
- Too generic: make Xiaohei the action subject, add a strange-but-coherent metaphor.
...
A high-quality image should make the reader think "that's a little weird" first, then understand the structure within 1 second.

If the first impression reads like a tutorial page rather than a quirky product sketch on white paper, it's not good enough.
